...
Observations:  
1. Pearson coefficient (ranges between 0 and 1) is a measure of LINEAR correlation  
2. Spearman coefficient (measured between 0 and 1) indicates MONOTONIC (linear or not) correlation  
