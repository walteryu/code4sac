...
# Use code below if running for the first time to create 5k dataset:
...
r <- raster(xmn=-87.5, xmx=-87, ymn=-87.5, ymx=-87, ncol=50, nrow=50)
...
```{r fig.width=9, fig.height=6, eval=FALSE, echo=FALSE}
