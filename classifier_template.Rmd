...
References - HW9-P2.1:  
1. HES CSCI-E63c HW9; LDA/QDA model  
2. ISLR p.139; LDA  
3. ISLR p.149; QDA  

Steps:  
1. Fit LDA/QDA classifiers  
2. Calculate LDA/QDA summary statistics  
3. Make predictions with LDA/QDA classifiers  
4. Create contingency tables to evaluate LDA/QDA classifiers  
5. Document observations below  

Observations:  
1. Contingency table helped to visualize results  
2. Contingency table showed reasonably good model fit  
3. Prediction quality function used to evaluate fit  
